...
export const getStaticProps = async ({ params }) => {
  ...
  const { data } = await axios.get(`${dev ? DEV_URL : PROD_URL}/api/products/${params.id}?NEXT_PUBLIC_API_KEY_METHOD_GET=FCdjakJOq6yRXCEr0L1a9JnFrNmM5UkjDqIM4pTvplFNIODl8vuIXzfEc`);
  const response = data;
  return {
    props: {
      response,
